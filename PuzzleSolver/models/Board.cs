            ...
            for (int i = 0; i < 4; i++)//O(1)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        b.gridToHash();//O(N^2)
                        if (closeList.Contains(b.hashCode)) // O(1)
                        {
                            continue;
                        }
                        b.setParent(this);
                        ...
                        if (type == 0)
                        {
                            total = b.getStateDepth() + b.getHammingDistance();//O(N^2)
                        }
                        else
                        {
                            total = b.getStateDepth() + b.getManhattanDistance();//O(N^2)
                        }
                        b.setTotalDest(total);
                        openList.enqueue(b);//O(Log(N))
                    }
                }
                catch
                {
